...
timeline
  .from('.posts__title', { delay: .4, ease: 'power1.inOut' , opacity: 0, duration: .4 })
  .from('.player', { opacity: 0 })

  gsap.fromTo(about.children, {y: '+=100', opacity: 0}, {y: 0, opacity: 1, stagger: .2, duration: .9, ease: 'easeInOut', scrollTrigger: {
    trigger: '.about',
    start: '0% 60%',
    // markers: true
  }})
